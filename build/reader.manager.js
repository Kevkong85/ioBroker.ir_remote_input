...
class ReaderManger {
  constructor(_adapterInstance, _store) {
    ...
    this._keyEvent$.pipe((0, import_rxjs.filter)((data) => data.value === 1), (0, import_rxjs.switchMap)((startEvent) => (0, import_rxjs.race)([
      this._keyEvent$.pipe((0, import_rxjs.filter)((data) => data.value === 0), (0, import_rxjs.map)((_) => startEvent), (0, import_rxjs.first)()),
      this._keyEvent$.pipe((0, import_rxjs.takeWhile)((data) => data.value === 2))
